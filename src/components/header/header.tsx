      ...
      <div className={cn(styles.bar, "flex items-center justify-between")}>
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-lg bg-green-500 hover:bg-green-600 text-white text-xs md:text-sm font-medium transition-colors"
          >
