...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.FASTAPI]: {
    ...
    name: "fastapi",
    label: "FastAPI",
    shortDescription: "high-performance APIs built with absolute speed ⚡🚀",
    color: "#009688",
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "writing clean, powerful backend logic and AI agents 🐍🔥",
    color: "#3776ab",
  ...
  [SkillNames.N8N]: {
    ...
    name: "n8n",
    label: "n8n",
    shortDescription: "workflow automation to streamline your operations 🤖🚀",
    color: "#ff6d5a",
  ...
  [SkillNames.FIGMA]: {
    ...
    name: "figma",
    label: "Figma",
    shortDescription: "crafting premium, responsive designs and wireframes 🎨🖌️",
    color: "#f24e1e",
